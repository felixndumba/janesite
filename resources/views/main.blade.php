        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-16">
            ...
            <div data-aos="zoom-in-right" data-aos-delay="200" data-aos-duration="1000">
                <h1 class="text-5xl md:text-6xl font-extrabold leading-tight mb-6 tracking-tight">
                    Guiding You to Financial<br><span class="text-[#f8dab2]">Freedom & Growth</span>
                </h1>
                ...
                <a href="{{ url('/services') }}"
                   class="inline-block bg-white text-[#a04f3f] font-semibold px-8 py-3 rounded-full shadow-md hover:scale-105 hover:bg-gray-100 transition-all duration-300 ease-in-out">
                    View Our Services
                </a>
            </div>
