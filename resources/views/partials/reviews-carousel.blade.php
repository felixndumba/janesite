<style>
    ...
    /* soft fade at the scroll edges so it reads as "more content" on mobile */
    .reviews-fade {
...
<section class="relative overflow-hidden bg-[#FAF8F5] py-16 sm:py-24">
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div class="relative overflow-hidden">
            ...
            {{-- mobile scroll hint dots (purely visual, no JS state needed) --}}
            <div class="mt-2 flex justify-center gap-1.5 lg:hidden" aria-hidden="true">
                <span class="h-1.5 w-4 rounded-full bg-gray-900/70"></span>
