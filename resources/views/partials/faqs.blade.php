<section class=" py-10 px-6"  data-aos="zoom-in-right" data-aos-delay="200" data-aos-duration="1000" >
    <div class="max-w-4xl mx-auto">
        <h2 class="text-5xl font-extrabold text-center mb-10" style="color: #E2B287;">FAQs</h2>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md border border-orange-200 p-6 hover:shadow-lg transition-shadow duration-300">
                ...
                <ul class="list-disc pl-6 space-y-1 text-gray-700">
                    ...
                    <li>Other investments: Government securities, Local & International Stocks, Special Funds (e.g., Mansa X), Real Estate (e.g., REITS) etc.</li>
                </ul>
            </div>
