<section class="relative bg-no-repeat bg-auto bg-center" style="background-image: url('{{ asset('images/backimage1.jpg') }}');">
  <!-- Overlay -->
  ...
  <div class="relative max-w-4xl mx-auto px-6 py-20 text-center text-white">
    ...
    <a href="{{ route('services') }}" 
       class="bg-[#b25d4c] hover:bg-[#8a4638] text-white font-semibold py-3 px-6 rounded-lg shadow-lg transition">
